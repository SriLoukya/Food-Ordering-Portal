...
const Buyerfoodlist = (props) => {
    ...
    function onsubmit(food_name, price, rating, food_type, add_ons, vendor_email,  shop_name, vendor_name) {
        ...
        axios
            .post("/api/food/buyerorder", newUser3)
            .then((response) => {
                alert("Order Placed");
    ...
    function onSubmitFav(food_name, price, rating, food_type, add_ons, vendor_email, quantity, shop_name, vendor_name) {
        ...
        axios
            .post("/api/food/buyerfav", newUser4)
            .then((response) => {
